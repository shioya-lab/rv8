...
const char* rv_fmt_vd_vs2_vs1_v0   =       "O\t8,d,b";
const char* rv_fmt_vd_vs2_vs1_v0t  =       "O\t8,d,b,z";
const char* rv_fmt_vd_vs2_rs1_v0   =       "O\t8,d,1";
const char* rv_fmt_vd_vs2_rs1_v0t   =      "O\t8,d,1,z";
const char* rv_fmt_vd_vs2_vs1_vd   =       "O\t8,d,b";
const char* rv_fmt_vd_vs2_frs1  =          "O\t8,d,4";
const char* rv_fmt_vd_vs2_simm5 =          "O\t8,d,i";
const char* rv_fmt_vd_vs2_simm5_v0t =      "O\t8,d,i,z";
const char* rv_fmt_vd_simm5 =              "O\t8,i";
const char* rv_fmt_vd_vs2 =                "O\t8,d";
const char* rv_fmt_rd_vs2 =                "O\t0,d";
const char* rv_fmt_rd_imm12_oimm12 =       "O\t0,i,i";
const char* rv_fmt_vd_rs1_vs2  =           "O\t8,(1),d";
const char* rv_fmt_vs3_rs1_vs2 =           "O\t9,(1),d";
const char* rv_fmt_vd_rs1_vs2_v0t  =       "O\t8,(1),d,z";
const char* rv_fmt_vs3_rs1_vs2_v0t =       "O\t9,(1),d,z";
const char* rv_fmt_frd_vs2     =           "O\t3,d";
