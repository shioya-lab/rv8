...
template <typename T> inline void decode_i_vvm(T &dec, inst_t inst)
{
	dec.rd  = operand_rd::decode(inst);
	dec.rs1 = operand_rs1::decode(inst);
	dec.rs2 = operand_rs2::decode(inst);
...
template <typename T> inline void decode_i_vrm(T &dec, inst_t inst)
{
	dec.rd = operand_rd::decode(inst);
	dec.rs1 = operand_rs1::decode(inst);
	dec.rs2 = operand_rs2::decode(inst);
...
template <typename T> inline void decode_i_vim (T &dec, inst_t inst)
{
	dec.rd = operand_rd::decode(inst);
	dec.rs1 = rv_ireg_zero;
	dec.rs2 = operand_rs2::decode(inst);
...
template <typename T> inline void decode_i_iv(T &dec, inst_t inst)
{
	dec.rd = operand_rd::decode(inst);
	dec.rs1 = rv_ireg_zero;
	dec.rs2 = operand_rs2::decode(inst);
