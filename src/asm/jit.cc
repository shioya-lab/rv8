...
inst_t riscv::emit_vle8ff_v(vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vle16ff_v(vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vle32ff_v(vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vle64ff_v(vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vs1re8_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vs1re16_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vs1re32_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vs1re64_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vs2re8_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vs2re16_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vs2re32_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vs2re64_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vs4re8_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vs4re16_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vs4re32_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vs4re64_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vs8re8_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vs8re16_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vs8re32_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vs8re64_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vluxei8_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vsuxei8_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vluxei16_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vsuxei16_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vluxei32_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vsuxei32_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vluxei64_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vsuxei64_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vloxei8_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vsoxei8_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vloxei16_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vsoxei16_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vloxei32_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vsoxei32_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vloxei64_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vsoxei64_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vluxei8_vm(vreg5 vd, ireg5 rs1, vreg5 vs2, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid() && v0t.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vsuxei8_vm(vreg5 vs3, ireg5 rs1, vreg5 vs2, vreg1 v0t)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid() && v0t.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vluxei16_vm(vreg5 vd, ireg5 rs1, vreg5 vs2, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid() && v0t.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vsuxei16_vm(vreg5 vs3, ireg5 rs1, vreg5 vs2, vreg1 v0t)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid() && v0t.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vluxei32_vm(vreg5 vd, ireg5 rs1, vreg5 vs2, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid() && v0t.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vsuxei32_vm(vreg5 vs3, ireg5 rs1, vreg5 vs2, vreg1 v0t)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid() && v0t.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vluxei64_vm(vreg5 vd, ireg5 rs1, vreg5 vs2, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid() && v0t.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vsuxei64_vm(vreg5 vs3, ireg5 rs1, vreg5 vs2, vreg1 v0t)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid() && v0t.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vloxei8_vm(vreg5 vd, ireg5 rs1, vreg5 vs2, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid() && v0t.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vsoxei8_vm(vreg5 vs3, ireg5 rs1, vreg5 vs2, vreg1 v0t)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid() && v0t.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vloxei16_vm(vreg5 vd, ireg5 rs1, vreg5 vs2, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid() && v0t.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vsoxei16_vm(vreg5 vs3, ireg5 rs1, vreg5 vs2, vreg1 v0t)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid() && v0t.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vloxei32_vm(vreg5 vd, ireg5 rs1, vreg5 vs2, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid() && v0t.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vsoxei32_vm(vreg5 vs3, ireg5 rs1, vreg5 vs2, vreg1 v0t)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid() && v0t.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vloxei64_vm(vreg5 vd, ireg5 rs1, vreg5 vs2, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid() && v0t.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vsoxei64_vm(vreg5 vs3, ireg5 rs1, vreg5 vs2, vreg1 v0t)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid() && v0t.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vlseg2e8_v(vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlseg2e8_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vsseg2e8_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsseg2e8_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vlseg2e16_v(vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlseg2e16_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vsseg2e16_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsseg2e16_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vlseg2e32_v(vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlseg2e32_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vsseg2e32_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsseg2e32_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vlseg2e64_v(vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlseg2e64_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vsseg2e64_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsseg2e64_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vlsseg2e8_v(vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlsseg2e8_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vssseg2e8_v(vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vssseg2e8_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vlsseg2e16_v(vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlsseg2e16_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vssseg2e16_v(vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vssseg2e16_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vlsseg2e32_v(vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlsseg2e32_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vssseg2e32_v(vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vssseg2e32_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vlsseg2e64_v(vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlsseg2e64_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vssseg2e64_v(vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vssseg2e64_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vluxseg2ei8_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vluxseg2ei8_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsuxseg2ei8_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsuxseg2ei8_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vluxseg2ei16_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vluxseg2ei16_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsuxseg2ei16_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsuxseg2ei16_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vluxseg2ei32_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vluxseg2ei32_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsuxseg2ei32_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsuxseg2ei32_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vluxseg2ei64_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vluxseg2ei64_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsuxseg2ei64_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsuxseg2ei64_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vloxseg2ei8_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vloxseg2ei8_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsoxseg2ei8_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsoxseg2ei8_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vloxseg2ei16_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vloxseg2ei16_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsoxseg2ei16_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsoxseg2ei16_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vloxseg2ei32_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vloxseg2ei32_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsoxseg2ei32_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsoxseg2ei32_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vloxseg2ei64_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vloxseg2ei64_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsoxseg2ei64_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsoxseg2ei64_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vlseg3e8_v(vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlseg3e8_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vsseg3e8_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsseg3e8_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vlseg3e16_v(vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlseg3e16_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vsseg3e16_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsseg3e16_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vlseg3e32_v(vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlseg3e32_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vsseg3e32_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsseg3e32_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vlseg3e64_v(vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlseg3e64_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vsseg3e64_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsseg3e64_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vlsseg3e8_v(vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlsseg3e8_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vssseg3e8_v(vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vssseg3e8_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vlsseg3e16_v(vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlsseg3e16_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vssseg3e16_v(vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vssseg3e16_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vlsseg3e32_v(vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlsseg3e32_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vssseg3e32_v(vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vssseg3e32_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vlsseg3e64_v(vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlsseg3e64_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vssseg3e64_v(vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vssseg3e64_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vluxseg3ei8_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vluxseg3ei8_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsuxseg3ei8_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsuxseg3ei8_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vluxseg3ei16_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vluxseg3ei16_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsuxseg3ei16_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsuxseg3ei16_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vluxseg3ei32_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vluxseg3ei32_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsuxseg3ei32_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsuxseg3ei32_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vluxseg3ei64_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vluxseg3ei64_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsuxseg3ei64_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsuxseg3ei64_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vloxseg3ei8_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vloxseg3ei8_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsoxseg3ei8_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsoxseg3ei8_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vloxseg3ei16_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vloxseg3ei16_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsoxseg3ei16_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsoxseg3ei16_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vloxseg3ei32_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vloxseg3ei32_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsoxseg3ei32_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsoxseg3ei32_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vloxseg3ei64_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vloxseg3ei64_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsoxseg3ei64_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsoxseg3ei64_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vlseg4e8_v(vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlseg4e8_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vsseg4e8_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsseg4e8_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vlseg4e16_v(vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlseg4e16_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vsseg4e16_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsseg4e16_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vlseg4e32_v(vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vsseg4e32_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vlseg4e64_v(vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlseg4e64_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vsseg4e64_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsseg4e64_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vlsseg4e8_v(vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlsseg4e8_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vssseg4e8_v(vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vssseg4e8_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vlsseg4e16_v(vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlsseg4e16_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vssseg4e16_v(vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vssseg4e16_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vlsseg4e32_v(vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlsseg4e32_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vssseg4e32_v(vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vssseg4e32_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vlsseg4e64_v(vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlsseg4e64_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vssseg4e64_v(vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vssseg4e64_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vluxseg4ei8_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vluxseg4ei8_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsuxseg4ei8_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsuxseg4ei8_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vluxseg4ei16_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vluxseg4ei16_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsuxseg4ei16_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsuxseg4ei16_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vluxseg4ei32_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vluxseg4ei32_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsuxseg4ei32_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsuxseg4ei32_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vluxseg4ei64_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vluxseg4ei64_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsuxseg4ei64_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsuxseg4ei64_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vloxseg4ei8_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vloxseg4ei8_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsoxseg4ei8_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsoxseg4ei8_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vloxseg4ei16_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vloxseg4ei16_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsoxseg4ei16_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsoxseg4ei16_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vloxseg4ei32_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vloxseg4ei32_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsoxseg4ei32_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsoxseg4ei32_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vloxseg4ei64_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vloxseg4ei64_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsoxseg4ei64_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsoxseg4ei64_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vlseg5e8_v(vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlseg5e8_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vsseg5e8_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsseg5e8_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vlseg5e16_v(vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlseg5e16_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vsseg5e16_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsseg5e16_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vlseg5e32_v(vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlseg5e32_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vsseg5e32_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsseg5e32_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vlseg5e64_v(vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlseg5e64_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vsseg5e64_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsseg5e64_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vlsseg5e8_v(vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlsseg5e8_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vssseg5e8_v(vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vssseg5e8_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vlsseg5e16_v(vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlsseg5e16_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vssseg5e16_v(vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vssseg5e16_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vlsseg5e32_v(vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlsseg5e32_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vssseg5e32_v(vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vssseg5e32_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vlsseg5e64_v(vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlsseg5e64_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vssseg5e64_v(vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vssseg5e64_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vluxseg5ei8_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vluxseg5ei8_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsuxseg5ei8_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsuxseg5ei8_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vluxseg5ei16_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vluxseg5ei16_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsuxseg5ei16_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsuxseg5ei16_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vluxseg5ei32_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vluxseg5ei32_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsuxseg5ei32_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsuxseg5ei32_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vluxseg5ei64_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vluxseg5ei64_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsuxseg5ei64_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsuxseg5ei64_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vloxseg5ei8_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vloxseg5ei8_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsoxseg5ei8_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsoxseg5ei8_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vloxseg5ei16_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vloxseg5ei16_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsoxseg5ei16_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsoxseg5ei16_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vloxseg5ei32_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vloxseg5ei32_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsoxseg5ei32_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsoxseg5ei32_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vloxseg5ei64_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vloxseg5ei64_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsoxseg5ei64_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsoxseg5ei64_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vlseg6e8_v(vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlseg6e8_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vsseg6e8_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsseg6e8_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vlseg6e16_v(vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlseg6e16_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vsseg6e16_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsseg6e16_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vlseg6e32_v(vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlseg6e32_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vsseg6e32_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsseg6e32_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vlseg6e64_v(vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlseg6e64_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vsseg6e64_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsseg6e64_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vlsseg6e8_v(vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlsseg6e8_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vssseg6e8_v(vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vssseg6e8_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vlsseg6e16_v(vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlsseg6e16_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vssseg6e16_v(vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vssseg6e16_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vlsseg6e32_v(vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlsseg6e32_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vssseg6e32_v(vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vssseg6e32_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vlsseg6e64_v(vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlsseg6e64_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vssseg6e64_v(vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vssseg6e64_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vluxseg6ei8_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vluxseg6ei8_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsuxseg6ei8_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsuxseg6ei8_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vluxseg6ei16_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vluxseg6ei16_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsuxseg6ei16_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsuxseg6ei16_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vluxseg6ei32_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vluxseg6ei32_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsuxseg6ei32_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsuxseg6ei32_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vluxseg6ei64_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vluxseg6ei64_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsuxseg6ei64_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsuxseg6ei64_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vloxseg6ei8_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vloxseg6ei8_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsoxseg6ei8_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsoxseg6ei8_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vloxseg6ei16_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vloxseg6ei16_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsoxseg6ei16_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsoxseg6ei16_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vloxseg6ei32_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vloxseg6ei32_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsoxseg6ei32_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsoxseg6ei32_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vloxseg6ei64_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vloxseg6ei64_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsoxseg6ei64_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsoxseg6ei64_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vlseg7e8_v(vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlseg7e8_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vsseg7e8_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsseg7e8_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vlseg7e16_v(vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlseg7e16_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vsseg7e16_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsseg7e16_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vlseg7e32_v(vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlseg7e32_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vsseg7e32_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsseg7e32_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vlseg7e64_v(vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlseg7e64_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vsseg7e64_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsseg7e64_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vlsseg7e8_v(vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlsseg7e8_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vssseg7e8_v(vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vssseg7e8_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vlsseg7e16_v(vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlsseg7e16_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vssseg7e16_v(vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vssseg7e16_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vlsseg7e32_v(vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlsseg7e32_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vssseg7e32_v(vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vssseg7e32_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vlsseg7e64_v(vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlsseg7e64_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vssseg7e64_v(vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vssseg7e64_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vluxseg7ei8_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vluxseg7ei8_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsuxseg7ei8_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsuxseg7ei8_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vluxseg7ei16_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vluxseg7ei16_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsuxseg7ei16_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsuxseg7ei16_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vluxseg7ei32_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vluxseg7ei32_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsuxseg7ei32_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsuxseg7ei32_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vluxseg7ei64_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vluxseg7ei64_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsuxseg7ei64_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsuxseg7ei64_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vloxseg7ei8_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vloxseg7ei8_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsoxseg7ei8_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsoxseg7ei8_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vloxseg7ei16_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vloxseg7ei16_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsoxseg7ei16_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsoxseg7ei16_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vloxseg7ei32_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vloxseg7ei32_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsoxseg7ei32_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsoxseg7ei32_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vloxseg7ei64_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vloxseg7ei64_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsoxseg7ei64_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsoxseg7ei64_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vlseg8e8_v(vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlseg8e8_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vsseg8e8_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsseg8e8_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vlseg8e16_v(vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlseg8e16_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vsseg8e16_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsseg8e16_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vlseg8e32_v(vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vsseg8e32_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vlseg8e64_v(vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlseg8e64_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vsseg8e64_v(vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsseg8e64_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	return encode_inst(dec);
}

inst_t riscv::emit_vlsseg8e8_v(vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlsseg8e8_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vssseg8e8_v(vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vssseg8e8_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vlsseg8e16_v(vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlsseg8e16_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vssseg8e16_v(vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vssseg8e16_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vlsseg8e32_v(vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlsseg8e32_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vssseg8e32_v(vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vssseg8e32_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vlsseg8e64_v(vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vlsseg8e64_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vssseg8e64_v(vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vssseg8e64_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
	dec.rs2 = rs2;
	return encode_inst(dec);
...
inst_t riscv::emit_vluxseg8ei8_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vluxseg8ei8_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsuxseg8ei8_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsuxseg8ei8_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vluxseg8ei16_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vluxseg8ei16_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsuxseg8ei16_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsuxseg8ei16_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vluxseg8ei32_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vluxseg8ei32_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsuxseg8ei32_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsuxseg8ei32_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vluxseg8ei64_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vluxseg8ei64_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsuxseg8ei64_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsuxseg8ei64_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vloxseg8ei8_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vloxseg8ei8_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsoxseg8ei8_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsoxseg8ei8_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vloxseg8ei16_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vloxseg8ei16_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsoxseg8ei16_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsoxseg8ei16_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vloxseg8ei32_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vloxseg8ei32_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsoxseg8ei32_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsoxseg8ei32_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vloxseg8ei64_v(vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vloxseg8ei64_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vsoxseg8ei64_v(vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsoxseg8ei64_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vadd_vvm(vreg5 vd, vreg5 vs2, vreg5 vs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vadd_vvm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
/* dec.? = vs1 unhandled */
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vsub_vvm(vreg5 vd, vreg5 vs2, vreg5 vs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsub_vvm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
/* dec.? = vs1 unhandled */
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vminu_vvm(vreg5 vd, vreg5 vs2, vreg5 vs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vminu_vvm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
/* dec.? = vs1 unhandled */
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vmin_vvm(vreg5 vd, vreg5 vs2, vreg5 vs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vmin_vvm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
/* dec.? = vs1 unhandled */
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vmaxu_vvm(vreg5 vd, vreg5 vs2, vreg5 vs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vmaxu_vvm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
/* dec.? = vs1 unhandled */
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vmax_vvm(vreg5 vd, vreg5 vs2, vreg5 vs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vmax_vvm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
/* dec.? = vs1 unhandled */
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vand_vvm(vreg5 vd, vreg5 vs2, vreg5 vs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vand_vvm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
/* dec.? = vs1 unhandled */
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vor_vvm(vreg5 vd, vreg5 vs2, vreg5 vs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vor_vvm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
/* dec.? = vs1 unhandled */
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vxor_vvm(vreg5 vd, vreg5 vs2, vreg5 vs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vxor_vvm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
/* dec.? = vs1 unhandled */
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vrgather_vvm(vreg5 vd, vreg5 vs2, vreg5 vs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vrgather_vvm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
/* dec.? = vs1 unhandled */
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vmv_vx(vreg5 vd, vreg5 vs2, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vmv_vx;
...
inst_t riscv::emit_vadd_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vadd_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vsub_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsub_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vrsub_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vrsub_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vminu_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vminu_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vmin_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vmin_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vmaxu_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vmaxu_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vmax_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vmax_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vand_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vand_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vor_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vor_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vxor_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vxor_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vrgather_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vrgather_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vslideup_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vslideup_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vslidedown_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vslidedown_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vadc_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vadc_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vmadc_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vmadc_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vsbc_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsbc_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vmsbc_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vmsbc_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vmseq_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vmseq_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vmsne_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vmsne_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vmsltu_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vmsltu_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vmslt_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vmslt_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vmsleu_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vmsleu_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vmsle_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vmsle_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vmsgtu_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vmsgtu_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vmsgt_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vmsgt_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vsaddu_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsaddu_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vsadd_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsadd_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vssubu_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vssubu_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vssub_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vssub_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vsll_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsll_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vsmul_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsmul_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vsrl_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsrl_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vsra_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vsra_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vssrl_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vssrl_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vssra_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vssra_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vnsrl_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vnsrl_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vnsra_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vnsra_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vnclipu_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vnclipu_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vnclip_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vnclip_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vwredsumu_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vwredsumu_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vwredsum_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vwredsum_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vdotu_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vdotu_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vdot_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vdot_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vqmaccu_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vqmaccu_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vqmacc_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vqmacc_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vqmaccus_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vqmaccus_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vqmaccsu_vxm(vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vqmaccsu_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vmv_vi(vreg5 vd, simm1 simm5)
{
	decode dec;
	if (!(vd.valid() && simm5.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vmv_vi;
/* dec.? = vd unhandled */
	dec.imm = simm5;
	return encode_inst(dec);
...
inst_t riscv::emit_vadd_vim(vreg5 vd, vreg5 vs2, simm1 simm5, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && simm5.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vadd_vim;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.imm = simm5;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vrsub_vim(vreg5 vd, vreg5 vs2, simm1 simm5, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && simm5.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vrsub_vim;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.imm = simm5;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vand_vim(vreg5 vd, vreg5 vs2, simm1 simm5, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && simm5.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vand_vim;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.imm = simm5;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vor_vim(vreg5 vd, vreg5 vs2, simm1 simm5, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && simm5.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vor_vim;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.imm = simm5;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vxor_vim(vreg5 vd, vreg5 vs2, simm1 simm5, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && simm5.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vxor_vim;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.imm = simm5;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vrgather_vim(vreg5 vd, vreg5 vs2, simm1 simm5, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && simm5.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vrgather_vim;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.imm = simm5;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vslideup_vim(vreg5 vd, vreg5 vs2, simm1 simm5, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && simm5.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vslideup_vim;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.imm = simm5;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vslidedown_vim(vreg5 vd, vreg5 vs2, simm1 simm5, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && simm5.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vslidedown_vim;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.imm = simm5;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vadc_vim(vreg5 vd, vreg5 vs2, simm1 simm5, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && simm5.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vadc_vim;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.imm = simm5;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vmadc_vim(vreg5 vd, vreg5 vs2, simm1 simm5, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && simm5.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vmadc_vim;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.imm = simm5;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vmerge_vim(vreg5 vd, vreg5 vs2, simm1 simm5, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && simm5.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vmerge_vim;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.imm = simm5;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vmseq_vim(vreg5 vd, vreg5 vs2, simm1 simm5, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && simm5.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vmseq_vim;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.imm = simm5;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vmsne_vim(vreg5 vd, vreg5 vs2, simm1 simm5, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && simm5.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vmsne_vim;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.imm = simm5;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vmsleu_vim(vreg5 vd, vreg5 vs2, simm1 simm5, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && simm5.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vmsleu_vim;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.imm = simm5;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vmsle_vim(vreg5 vd, vreg5 vs2, simm1 simm5, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && simm5.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vmsle_vim;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.imm = simm5;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vmsgtu_vim(vreg5 vd, vreg5 vs2, simm1 simm5, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && simm5.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vmsgtu_vim;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.imm = simm5;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vmsgt_vim(vreg5 vd, vreg5 vs2, simm1 simm5, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && simm5.valid() && v0t.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vmsgt_vim;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.imm = simm5;
/* dec.? = v0t unhandled */
...
inst_t riscv::emit_vredsum_vs(vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vredsum_vs;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
/* dec.? = vs1 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vredand_vs(vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vredand_vs;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
/* dec.? = vs1 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vredor_vs(vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vredor_vs;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
/* dec.? = vs1 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vredxor_vs(vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vredxor_vs;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
/* dec.? = vs1 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vredminu_vs(vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vredminu_vs;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
/* dec.? = vs1 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vredmin_vs(vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vredmin_vs;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
/* dec.? = vs1 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vredmaxu_vs(vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vredmaxu_vs;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
/* dec.? = vs1 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vredmax_vs(vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vredmax_vs;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
/* dec.? = vs1 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vmv_x_s(ireg5 rd, vreg5 vs2)
{
	decode dec;
	if (!(rd.valid() && vs2.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vpopc_m(ireg5 rd, vreg5 vs2)
{
	decode dec;
	if (!(rd.valid() && vs2.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfirst_m(ireg5 rd, vreg5 vs2)
{
	decode dec;
	if (!(rd.valid() && vs2.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vmfle_vx(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vmflt_vx(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vmfne_vx(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfmul_vv(vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfwadd_vv(vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vfwadd_vv;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
/* dec.? = vs1 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vfwredsum_vv(vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vfwredsum_vv;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
/* dec.? = vs1 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vfwsub_vv(vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vfwsub_vv;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
/* dec.? = vs1 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vfwredosum_vv(vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vfwredosum_vv;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
/* dec.? = vs1 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vfwadd_wv(vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfwsub_wv(vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfwmul_vv(vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vfwmul_vv;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
/* dec.? = vs1 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vfdot_vv(vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vfdot_vv;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
/* dec.? = vs1 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vfwmacc_vv(vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vfwmacc_vv;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
/* dec.? = vs1 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vfwnmacc_vv(vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vfwnmacc_vv;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
/* dec.? = vs1 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vfwmsac_vv(vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vfwmsac_vv;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
/* dec.? = vs1 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vfwnmsac_vv(vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vfwnmsac_vv;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
/* dec.? = vs1 unhandled */
	return encode_inst(dec);
...
inst_t riscv::emit_vfadd_vf(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfredsum_vf(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfsub_vf(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfredosum_vf(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfmin_vf(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfredmin_vf(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfmax_vf(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfredmax_vf(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfsgnj_vf(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfsgnjn_vf(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfsgnjx_vf(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfmv_s_f(vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfmv_f_s(freg5 frd, vreg5 vs2)
{
	decode dec;
	if (!(frd.valid() && vs2.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfmv_v_f(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vfmv_v_f;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = frs1;
	return encode_inst(dec);
...
inst_t riscv::emit_vmfeq_vf(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vmfle_vf(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vmflt_vf(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vmfne_vf(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vmfgt_vf(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vmfge_vf(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfdiv_vf(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfrdiv_vf(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfmul_vf(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfrsub_vf(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfwadd_vf(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfwredsum_vf(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfwsub_vf(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfwredosum_vf(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfwadd_wf(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfwsub_wf(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfwmul_vf(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfdot_vf(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfwmacc_vf(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfwnmacc_vf(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfwmsac_vf(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfwnmsac_vf(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
...
inst_t riscv::emit_vfsqrt_v(vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return 0; /* illegal instruction */
	dec.op = rv_op_vfsqrt_v;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = frs1;
	return encode_inst(dec);
...
bool riscv::asm_vle8ff_v(assembler &as, vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vle8ff_v;
...
bool riscv::asm_vle16ff_v(assembler &as, vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vle16ff_v;
...
bool riscv::asm_vle32ff_v(assembler &as, vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vle32ff_v;
...
bool riscv::asm_vle64ff_v(assembler &as, vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vle64ff_v;
...
bool riscv::asm_vs1re8_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vs1re8_v;
...
bool riscv::asm_vs1re16_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vs1re16_v;
...
bool riscv::asm_vs1re32_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vs1re32_v;
...
bool riscv::asm_vs1re64_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vs1re64_v;
...
bool riscv::asm_vs2re8_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vs2re8_v;
...
bool riscv::asm_vs2re16_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vs2re16_v;
...
bool riscv::asm_vs2re32_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vs2re32_v;
...
bool riscv::asm_vs2re64_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vs2re64_v;
...
bool riscv::asm_vs4re8_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vs4re8_v;
...
bool riscv::asm_vs4re16_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vs4re16_v;
...
bool riscv::asm_vs4re32_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vs4re32_v;
...
bool riscv::asm_vs4re64_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vs4re64_v;
...
bool riscv::asm_vs8re8_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vs8re8_v;
...
bool riscv::asm_vs8re16_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vs8re16_v;
...
bool riscv::asm_vs8re32_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vs8re32_v;
...
bool riscv::asm_vs8re64_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vs8re64_v;
...
bool riscv::asm_vluxei8_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxei8_v;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
...
bool riscv::asm_vsuxei8_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxei8_v;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
...
bool riscv::asm_vluxei16_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxei16_v;
...
bool riscv::asm_vsuxei16_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxei16_v;
...
bool riscv::asm_vluxei32_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxei32_v;
...
bool riscv::asm_vsuxei32_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxei32_v;
...
bool riscv::asm_vluxei64_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxei64_v;
...
bool riscv::asm_vsuxei64_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxei64_v;
...
bool riscv::asm_vloxei8_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxei8_v;
...
bool riscv::asm_vsoxei8_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxei8_v;
...
bool riscv::asm_vloxei16_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxei16_v;
...
bool riscv::asm_vsoxei16_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxei16_v;
...
bool riscv::asm_vloxei32_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxei32_v;
...
bool riscv::asm_vsoxei32_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxei32_v;
...
bool riscv::asm_vloxei64_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxei64_v;
...
bool riscv::asm_vsoxei64_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxei64_v;
...
bool riscv::asm_vluxei8_vm(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxei8_vm;
/* dec.? = vd unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
...
bool riscv::asm_vsuxei8_vm(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2, vreg1 v0t)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxei8_vm;
/* dec.? = vs3 unhandled */
	dec.rs1 = rs1;
/* dec.? = vs2 unhandled */
...
bool riscv::asm_vluxei16_vm(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxei16_vm;
...
bool riscv::asm_vsuxei16_vm(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2, vreg1 v0t)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxei16_vm;
...
bool riscv::asm_vluxei32_vm(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxei32_vm;
...
bool riscv::asm_vsuxei32_vm(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2, vreg1 v0t)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxei32_vm;
...
bool riscv::asm_vluxei64_vm(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxei64_vm;
...
bool riscv::asm_vsuxei64_vm(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2, vreg1 v0t)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxei64_vm;
...
bool riscv::asm_vloxei8_vm(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxei8_vm;
...
bool riscv::asm_vsoxei8_vm(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2, vreg1 v0t)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxei8_vm;
...
bool riscv::asm_vloxei16_vm(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxei16_vm;
...
bool riscv::asm_vsoxei16_vm(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2, vreg1 v0t)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxei16_vm;
...
bool riscv::asm_vloxei32_vm(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxei32_vm;
...
bool riscv::asm_vsoxei32_vm(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2, vreg1 v0t)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxei32_vm;
...
bool riscv::asm_vloxei64_vm(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxei64_vm;
...
bool riscv::asm_vsoxei64_vm(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2, vreg1 v0t)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxei64_vm;
...
bool riscv::asm_vlseg2e8_v(assembler &as, vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlseg2e8_v;
...
bool riscv::asm_vsseg2e8_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsseg2e8_v;
...
bool riscv::asm_vlseg2e16_v(assembler &as, vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlseg2e16_v;
...
bool riscv::asm_vsseg2e16_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsseg2e16_v;
...
bool riscv::asm_vlseg2e32_v(assembler &as, vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlseg2e32_v;
...
bool riscv::asm_vsseg2e32_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsseg2e32_v;
...
bool riscv::asm_vlseg2e64_v(assembler &as, vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlseg2e64_v;
...
bool riscv::asm_vsseg2e64_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsseg2e64_v;
...
bool riscv::asm_vlsseg2e8_v(assembler &as, vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlsseg2e8_v;
...
bool riscv::asm_vssseg2e8_v(assembler &as, vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vssseg2e8_v;
...
bool riscv::asm_vlsseg2e16_v(assembler &as, vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlsseg2e16_v;
...
bool riscv::asm_vssseg2e16_v(assembler &as, vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vssseg2e16_v;
...
bool riscv::asm_vlsseg2e32_v(assembler &as, vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlsseg2e32_v;
...
bool riscv::asm_vssseg2e32_v(assembler &as, vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vssseg2e32_v;
...
bool riscv::asm_vlsseg2e64_v(assembler &as, vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlsseg2e64_v;
...
bool riscv::asm_vssseg2e64_v(assembler &as, vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vssseg2e64_v;
...
bool riscv::asm_vluxseg2ei8_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxseg2ei8_v;
...
bool riscv::asm_vsuxseg2ei8_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxseg2ei8_v;
...
bool riscv::asm_vluxseg2ei16_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxseg2ei16_v;
...
bool riscv::asm_vsuxseg2ei16_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxseg2ei16_v;
...
bool riscv::asm_vluxseg2ei32_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxseg2ei32_v;
...
bool riscv::asm_vsuxseg2ei32_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxseg2ei32_v;
...
bool riscv::asm_vluxseg2ei64_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxseg2ei64_v;
...
bool riscv::asm_vsuxseg2ei64_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxseg2ei64_v;
...
bool riscv::asm_vloxseg2ei8_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxseg2ei8_v;
...
bool riscv::asm_vsoxseg2ei8_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxseg2ei8_v;
...
bool riscv::asm_vloxseg2ei16_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxseg2ei16_v;
...
bool riscv::asm_vsoxseg2ei16_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxseg2ei16_v;
...
bool riscv::asm_vloxseg2ei32_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxseg2ei32_v;
...
bool riscv::asm_vsoxseg2ei32_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxseg2ei32_v;
...
bool riscv::asm_vloxseg2ei64_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxseg2ei64_v;
...
bool riscv::asm_vsoxseg2ei64_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxseg2ei64_v;
...
bool riscv::asm_vlseg3e8_v(assembler &as, vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlseg3e8_v;
...
bool riscv::asm_vsseg3e8_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsseg3e8_v;
...
bool riscv::asm_vlseg3e16_v(assembler &as, vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlseg3e16_v;
...
bool riscv::asm_vsseg3e16_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsseg3e16_v;
...
bool riscv::asm_vlseg3e32_v(assembler &as, vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlseg3e32_v;
...
bool riscv::asm_vsseg3e32_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsseg3e32_v;
...
bool riscv::asm_vlseg3e64_v(assembler &as, vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlseg3e64_v;
...
bool riscv::asm_vsseg3e64_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsseg3e64_v;
...
bool riscv::asm_vlsseg3e8_v(assembler &as, vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlsseg3e8_v;
...
bool riscv::asm_vssseg3e8_v(assembler &as, vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vssseg3e8_v;
...
bool riscv::asm_vlsseg3e16_v(assembler &as, vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlsseg3e16_v;
...
bool riscv::asm_vssseg3e16_v(assembler &as, vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vssseg3e16_v;
...
bool riscv::asm_vlsseg3e32_v(assembler &as, vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlsseg3e32_v;
...
bool riscv::asm_vssseg3e32_v(assembler &as, vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vssseg3e32_v;
...
bool riscv::asm_vlsseg3e64_v(assembler &as, vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlsseg3e64_v;
...
bool riscv::asm_vssseg3e64_v(assembler &as, vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vssseg3e64_v;
...
bool riscv::asm_vluxseg3ei8_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxseg3ei8_v;
...
bool riscv::asm_vsuxseg3ei8_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxseg3ei8_v;
...
bool riscv::asm_vluxseg3ei16_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxseg3ei16_v;
...
bool riscv::asm_vsuxseg3ei16_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxseg3ei16_v;
...
bool riscv::asm_vluxseg3ei32_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxseg3ei32_v;
...
bool riscv::asm_vsuxseg3ei32_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxseg3ei32_v;
...
bool riscv::asm_vluxseg3ei64_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxseg3ei64_v;
...
bool riscv::asm_vsuxseg3ei64_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxseg3ei64_v;
...
bool riscv::asm_vloxseg3ei8_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxseg3ei8_v;
...
bool riscv::asm_vsoxseg3ei8_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxseg3ei8_v;
...
bool riscv::asm_vloxseg3ei16_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxseg3ei16_v;
...
bool riscv::asm_vsoxseg3ei16_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxseg3ei16_v;
...
bool riscv::asm_vloxseg3ei32_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxseg3ei32_v;
...
bool riscv::asm_vsoxseg3ei32_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxseg3ei32_v;
...
bool riscv::asm_vloxseg3ei64_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxseg3ei64_v;
...
bool riscv::asm_vsoxseg3ei64_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxseg3ei64_v;
...
bool riscv::asm_vlseg4e8_v(assembler &as, vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlseg4e8_v;
...
bool riscv::asm_vsseg4e8_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsseg4e8_v;
...
bool riscv::asm_vlseg4e16_v(assembler &as, vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlseg4e16_v;
...
bool riscv::asm_vsseg4e16_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsseg4e16_v;
...
bool riscv::asm_vlseg4e32_v(assembler &as, vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlseg4e32_v;
...
bool riscv::asm_vsseg4e32_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsseg4e32_v;
...
bool riscv::asm_vlseg4e64_v(assembler &as, vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlseg4e64_v;
...
bool riscv::asm_vsseg4e64_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsseg4e64_v;
...
bool riscv::asm_vlsseg4e8_v(assembler &as, vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlsseg4e8_v;
...
bool riscv::asm_vssseg4e8_v(assembler &as, vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vssseg4e8_v;
...
bool riscv::asm_vlsseg4e16_v(assembler &as, vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlsseg4e16_v;
...
bool riscv::asm_vssseg4e16_v(assembler &as, vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vssseg4e16_v;
...
bool riscv::asm_vlsseg4e32_v(assembler &as, vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlsseg4e32_v;
...
bool riscv::asm_vssseg4e32_v(assembler &as, vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vssseg4e32_v;
...
bool riscv::asm_vlsseg4e64_v(assembler &as, vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlsseg4e64_v;
...
bool riscv::asm_vssseg4e64_v(assembler &as, vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vssseg4e64_v;
...
bool riscv::asm_vluxseg4ei8_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxseg4ei8_v;
...
bool riscv::asm_vsuxseg4ei8_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxseg4ei8_v;
...
bool riscv::asm_vluxseg4ei16_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxseg4ei16_v;
...
bool riscv::asm_vsuxseg4ei16_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxseg4ei16_v;
...
bool riscv::asm_vluxseg4ei32_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxseg4ei32_v;
...
bool riscv::asm_vsuxseg4ei32_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxseg4ei32_v;
...
bool riscv::asm_vluxseg4ei64_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxseg4ei64_v;
...
bool riscv::asm_vsuxseg4ei64_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxseg4ei64_v;
...
bool riscv::asm_vloxseg4ei8_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxseg4ei8_v;
...
bool riscv::asm_vsoxseg4ei8_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxseg4ei8_v;
...
bool riscv::asm_vloxseg4ei16_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxseg4ei16_v;
...
bool riscv::asm_vsoxseg4ei16_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxseg4ei16_v;
...
bool riscv::asm_vloxseg4ei32_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxseg4ei32_v;
...
bool riscv::asm_vsoxseg4ei32_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxseg4ei32_v;
...
bool riscv::asm_vloxseg4ei64_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxseg4ei64_v;
...
bool riscv::asm_vsoxseg4ei64_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxseg4ei64_v;
...
bool riscv::asm_vlseg5e8_v(assembler &as, vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlseg5e8_v;
...
bool riscv::asm_vsseg5e8_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsseg5e8_v;
...
bool riscv::asm_vlseg5e16_v(assembler &as, vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlseg5e16_v;
...
bool riscv::asm_vsseg5e16_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsseg5e16_v;
...
bool riscv::asm_vlseg5e32_v(assembler &as, vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlseg5e32_v;
...
bool riscv::asm_vsseg5e32_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsseg5e32_v;
...
bool riscv::asm_vlseg5e64_v(assembler &as, vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlseg5e64_v;
...
bool riscv::asm_vsseg5e64_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsseg5e64_v;
...
bool riscv::asm_vlsseg5e8_v(assembler &as, vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlsseg5e8_v;
...
bool riscv::asm_vssseg5e8_v(assembler &as, vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vssseg5e8_v;
...
bool riscv::asm_vlsseg5e16_v(assembler &as, vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlsseg5e16_v;
...
bool riscv::asm_vssseg5e16_v(assembler &as, vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vssseg5e16_v;
...
bool riscv::asm_vlsseg5e32_v(assembler &as, vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlsseg5e32_v;
...
bool riscv::asm_vssseg5e32_v(assembler &as, vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vssseg5e32_v;
...
bool riscv::asm_vlsseg5e64_v(assembler &as, vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlsseg5e64_v;
...
bool riscv::asm_vssseg5e64_v(assembler &as, vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vssseg5e64_v;
...
bool riscv::asm_vluxseg5ei8_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxseg5ei8_v;
...
bool riscv::asm_vsuxseg5ei8_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxseg5ei8_v;
...
bool riscv::asm_vluxseg5ei16_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxseg5ei16_v;
...
bool riscv::asm_vsuxseg5ei16_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxseg5ei16_v;
...
bool riscv::asm_vluxseg5ei32_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxseg5ei32_v;
...
bool riscv::asm_vsuxseg5ei32_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxseg5ei32_v;
...
bool riscv::asm_vluxseg5ei64_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxseg5ei64_v;
...
bool riscv::asm_vsuxseg5ei64_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxseg5ei64_v;
...
bool riscv::asm_vloxseg5ei8_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxseg5ei8_v;
...
bool riscv::asm_vsoxseg5ei8_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxseg5ei8_v;
...
bool riscv::asm_vloxseg5ei16_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxseg5ei16_v;
...
bool riscv::asm_vsoxseg5ei16_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxseg5ei16_v;
...
bool riscv::asm_vloxseg5ei32_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxseg5ei32_v;
...
bool riscv::asm_vsoxseg5ei32_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxseg5ei32_v;
...
bool riscv::asm_vloxseg5ei64_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxseg5ei64_v;
...
bool riscv::asm_vsoxseg5ei64_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxseg5ei64_v;
...
bool riscv::asm_vlseg6e8_v(assembler &as, vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlseg6e8_v;
...
bool riscv::asm_vsseg6e8_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsseg6e8_v;
...
bool riscv::asm_vlseg6e16_v(assembler &as, vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlseg6e16_v;
...
bool riscv::asm_vsseg6e16_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsseg6e16_v;
...
bool riscv::asm_vlseg6e32_v(assembler &as, vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlseg6e32_v;
...
bool riscv::asm_vsseg6e32_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsseg6e32_v;
...
bool riscv::asm_vlseg6e64_v(assembler &as, vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlseg6e64_v;
...
bool riscv::asm_vsseg6e64_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsseg6e64_v;
...
bool riscv::asm_vlsseg6e8_v(assembler &as, vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlsseg6e8_v;
...
bool riscv::asm_vssseg6e8_v(assembler &as, vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vssseg6e8_v;
...
bool riscv::asm_vlsseg6e16_v(assembler &as, vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlsseg6e16_v;
...
bool riscv::asm_vssseg6e16_v(assembler &as, vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vssseg6e16_v;
...
bool riscv::asm_vlsseg6e32_v(assembler &as, vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlsseg6e32_v;
...
bool riscv::asm_vssseg6e32_v(assembler &as, vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vssseg6e32_v;
...
bool riscv::asm_vlsseg6e64_v(assembler &as, vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlsseg6e64_v;
...
bool riscv::asm_vssseg6e64_v(assembler &as, vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vssseg6e64_v;
...
bool riscv::asm_vluxseg6ei8_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxseg6ei8_v;
...
bool riscv::asm_vsuxseg6ei8_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxseg6ei8_v;
...
bool riscv::asm_vluxseg6ei16_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxseg6ei16_v;
...
bool riscv::asm_vsuxseg6ei16_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxseg6ei16_v;
...
bool riscv::asm_vluxseg6ei32_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxseg6ei32_v;
...
bool riscv::asm_vsuxseg6ei32_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxseg6ei32_v;
...
bool riscv::asm_vluxseg6ei64_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxseg6ei64_v;
...
bool riscv::asm_vsuxseg6ei64_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxseg6ei64_v;
...
bool riscv::asm_vloxseg6ei8_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxseg6ei8_v;
...
bool riscv::asm_vsoxseg6ei8_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxseg6ei8_v;
...
bool riscv::asm_vloxseg6ei16_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxseg6ei16_v;
...
bool riscv::asm_vsoxseg6ei16_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxseg6ei16_v;
...
bool riscv::asm_vloxseg6ei32_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxseg6ei32_v;
...
bool riscv::asm_vsoxseg6ei32_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxseg6ei32_v;
...
bool riscv::asm_vloxseg6ei64_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxseg6ei64_v;
...
bool riscv::asm_vsoxseg6ei64_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxseg6ei64_v;
...
bool riscv::asm_vlseg7e8_v(assembler &as, vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlseg7e8_v;
...
bool riscv::asm_vsseg7e8_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsseg7e8_v;
...
bool riscv::asm_vlseg7e16_v(assembler &as, vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlseg7e16_v;
...
bool riscv::asm_vsseg7e16_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsseg7e16_v;
...
bool riscv::asm_vlseg7e32_v(assembler &as, vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlseg7e32_v;
...
bool riscv::asm_vsseg7e32_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsseg7e32_v;
...
bool riscv::asm_vlseg7e64_v(assembler &as, vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlseg7e64_v;
...
bool riscv::asm_vsseg7e64_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsseg7e64_v;
...
bool riscv::asm_vlsseg7e8_v(assembler &as, vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlsseg7e8_v;
...
bool riscv::asm_vssseg7e8_v(assembler &as, vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vssseg7e8_v;
...
bool riscv::asm_vlsseg7e16_v(assembler &as, vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlsseg7e16_v;
...
bool riscv::asm_vssseg7e16_v(assembler &as, vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vssseg7e16_v;
...
bool riscv::asm_vlsseg7e32_v(assembler &as, vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlsseg7e32_v;
...
bool riscv::asm_vssseg7e32_v(assembler &as, vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vssseg7e32_v;
...
bool riscv::asm_vlsseg7e64_v(assembler &as, vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlsseg7e64_v;
...
bool riscv::asm_vssseg7e64_v(assembler &as, vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vssseg7e64_v;
...
bool riscv::asm_vluxseg7ei8_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxseg7ei8_v;
...
bool riscv::asm_vsuxseg7ei8_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxseg7ei8_v;
...
bool riscv::asm_vluxseg7ei16_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxseg7ei16_v;
...
bool riscv::asm_vsuxseg7ei16_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxseg7ei16_v;
...
bool riscv::asm_vluxseg7ei32_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxseg7ei32_v;
...
bool riscv::asm_vsuxseg7ei32_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxseg7ei32_v;
...
bool riscv::asm_vluxseg7ei64_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxseg7ei64_v;
...
bool riscv::asm_vsuxseg7ei64_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxseg7ei64_v;
...
bool riscv::asm_vloxseg7ei8_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxseg7ei8_v;
...
bool riscv::asm_vsoxseg7ei8_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxseg7ei8_v;
...
bool riscv::asm_vloxseg7ei16_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxseg7ei16_v;
...
bool riscv::asm_vsoxseg7ei16_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxseg7ei16_v;
...
bool riscv::asm_vloxseg7ei32_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxseg7ei32_v;
...
bool riscv::asm_vsoxseg7ei32_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxseg7ei32_v;
...
bool riscv::asm_vloxseg7ei64_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxseg7ei64_v;
...
bool riscv::asm_vsoxseg7ei64_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxseg7ei64_v;
...
bool riscv::asm_vlseg8e8_v(assembler &as, vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlseg8e8_v;
...
bool riscv::asm_vsseg8e8_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsseg8e8_v;
...
bool riscv::asm_vlseg8e16_v(assembler &as, vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlseg8e16_v;
...
bool riscv::asm_vsseg8e16_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsseg8e16_v;
...
bool riscv::asm_vlseg8e32_v(assembler &as, vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlseg8e32_v;
...
bool riscv::asm_vsseg8e32_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsseg8e32_v;
...
bool riscv::asm_vlseg8e64_v(assembler &as, vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlseg8e64_v;
...
bool riscv::asm_vsseg8e64_v(assembler &as, vreg5 vs3, ireg5 rs1)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsseg8e64_v;
...
bool riscv::asm_vlsseg8e8_v(assembler &as, vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlsseg8e8_v;
...
bool riscv::asm_vssseg8e8_v(assembler &as, vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vssseg8e8_v;
...
bool riscv::asm_vlsseg8e16_v(assembler &as, vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlsseg8e16_v;
...
bool riscv::asm_vssseg8e16_v(assembler &as, vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vssseg8e16_v;
...
bool riscv::asm_vlsseg8e32_v(assembler &as, vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlsseg8e32_v;
...
bool riscv::asm_vssseg8e32_v(assembler &as, vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vssseg8e32_v;
...
bool riscv::asm_vlsseg8e64_v(assembler &as, vreg5 vd, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vlsseg8e64_v;
...
bool riscv::asm_vssseg8e64_v(assembler &as, vreg5 vs3, ireg5 rs1, ireg5 rs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && rs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vssseg8e64_v;
...
bool riscv::asm_vluxseg8ei8_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxseg8ei8_v;
...
bool riscv::asm_vsuxseg8ei8_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxseg8ei8_v;
...
bool riscv::asm_vluxseg8ei16_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxseg8ei16_v;
...
bool riscv::asm_vsuxseg8ei16_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxseg8ei16_v;
...
bool riscv::asm_vluxseg8ei32_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxseg8ei32_v;
...
bool riscv::asm_vsuxseg8ei32_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxseg8ei32_v;
...
bool riscv::asm_vluxseg8ei64_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vluxseg8ei64_v;
...
bool riscv::asm_vsuxseg8ei64_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsuxseg8ei64_v;
...
bool riscv::asm_vloxseg8ei8_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxseg8ei8_v;
...
bool riscv::asm_vsoxseg8ei8_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxseg8ei8_v;
...
bool riscv::asm_vloxseg8ei16_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxseg8ei16_v;
...
bool riscv::asm_vsoxseg8ei16_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxseg8ei16_v;
...
bool riscv::asm_vloxseg8ei32_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxseg8ei32_v;
...
bool riscv::asm_vsoxseg8ei32_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxseg8ei32_v;
...
bool riscv::asm_vloxseg8ei64_v(assembler &as, vreg5 vd, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vd.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vloxseg8ei64_v;
...
bool riscv::asm_vsoxseg8ei64_v(assembler &as, vreg5 vs3, ireg5 rs1, vreg5 vs2)
{
	decode dec;
	if (!(vs3.valid() && rs1.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsoxseg8ei64_v;
...
bool riscv::asm_vadd_vvm(assembler &as, vreg5 vd, vreg5 vs2, vreg5 vs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vadd_vvm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
/* dec.? = vs1 unhandled */
...
bool riscv::asm_vsub_vvm(assembler &as, vreg5 vd, vreg5 vs2, vreg5 vs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsub_vvm;
...
bool riscv::asm_vminu_vvm(assembler &as, vreg5 vd, vreg5 vs2, vreg5 vs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vminu_vvm;
...
bool riscv::asm_vmin_vvm(assembler &as, vreg5 vd, vreg5 vs2, vreg5 vs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmin_vvm;
...
bool riscv::asm_vmaxu_vvm(assembler &as, vreg5 vd, vreg5 vs2, vreg5 vs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmaxu_vvm;
...
bool riscv::asm_vmax_vvm(assembler &as, vreg5 vd, vreg5 vs2, vreg5 vs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmax_vvm;
...
bool riscv::asm_vand_vvm(assembler &as, vreg5 vd, vreg5 vs2, vreg5 vs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vand_vvm;
...
bool riscv::asm_vor_vvm(assembler &as, vreg5 vd, vreg5 vs2, vreg5 vs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vor_vvm;
...
bool riscv::asm_vxor_vvm(assembler &as, vreg5 vd, vreg5 vs2, vreg5 vs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vxor_vvm;
...
bool riscv::asm_vrgather_vvm(assembler &as, vreg5 vd, vreg5 vs2, vreg5 vs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vrgather_vvm;
...
bool riscv::asm_vmv_vx(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmv_vx;
...
bool riscv::asm_vadd_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vadd_vxm;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.rs1 = rs1;
...
bool riscv::asm_vsub_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsub_vxm;
...
bool riscv::asm_vrsub_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vrsub_vxm;
...
bool riscv::asm_vminu_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vminu_vxm;
...
bool riscv::asm_vmin_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmin_vxm;
...
bool riscv::asm_vmaxu_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmaxu_vxm;
...
bool riscv::asm_vmax_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmax_vxm;
...
bool riscv::asm_vand_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vand_vxm;
...
bool riscv::asm_vor_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vor_vxm;
...
bool riscv::asm_vxor_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vxor_vxm;
...
bool riscv::asm_vrgather_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vrgather_vxm;
...
bool riscv::asm_vslideup_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vslideup_vxm;
...
bool riscv::asm_vslidedown_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vslidedown_vxm;
...
bool riscv::asm_vadc_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vadc_vxm;
...
bool riscv::asm_vmadc_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmadc_vxm;
...
bool riscv::asm_vsbc_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsbc_vxm;
...
bool riscv::asm_vmsbc_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmsbc_vxm;
...
bool riscv::asm_vmseq_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmseq_vxm;
...
bool riscv::asm_vmsne_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmsne_vxm;
...
bool riscv::asm_vmsltu_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmsltu_vxm;
...
bool riscv::asm_vmslt_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmslt_vxm;
...
bool riscv::asm_vmsleu_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmsleu_vxm;
...
bool riscv::asm_vmsle_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmsle_vxm;
...
bool riscv::asm_vmsgtu_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmsgtu_vxm;
...
bool riscv::asm_vmsgt_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmsgt_vxm;
...
bool riscv::asm_vsaddu_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsaddu_vxm;
...
bool riscv::asm_vsadd_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsadd_vxm;
...
bool riscv::asm_vssubu_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vssubu_vxm;
...
bool riscv::asm_vssub_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vssub_vxm;
...
bool riscv::asm_vsll_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsll_vxm;
...
bool riscv::asm_vsmul_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsmul_vxm;
...
bool riscv::asm_vsrl_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsrl_vxm;
...
bool riscv::asm_vsra_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vsra_vxm;
...
bool riscv::asm_vssrl_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vssrl_vxm;
...
bool riscv::asm_vssra_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vssra_vxm;
...
bool riscv::asm_vnsrl_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vnsrl_vxm;
...
bool riscv::asm_vnsra_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vnsra_vxm;
...
bool riscv::asm_vnclipu_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vnclipu_vxm;
...
bool riscv::asm_vnclip_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vnclip_vxm;
...
bool riscv::asm_vwredsumu_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vwredsumu_vxm;
...
bool riscv::asm_vwredsum_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vwredsum_vxm;
...
bool riscv::asm_vdotu_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vdotu_vxm;
...
bool riscv::asm_vdot_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vdot_vxm;
...
bool riscv::asm_vqmaccu_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vqmaccu_vxm;
...
bool riscv::asm_vqmacc_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vqmacc_vxm;
...
bool riscv::asm_vqmaccus_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vqmaccus_vxm;
...
bool riscv::asm_vqmaccsu_vxm(assembler &as, vreg5 vd, vreg5 vs2, ireg5 rs1, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && rs1.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vqmaccsu_vxm;
...
bool riscv::asm_vmv_vi(assembler &as, vreg5 vd, simm1 simm5)
{
	decode dec;
	if (!(vd.valid() && simm5.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmv_vi;
/* dec.? = vd unhandled */
	dec.imm = simm5;
	as.add_inst(encode_inst(dec));
...
bool riscv::asm_vadd_vim(assembler &as, vreg5 vd, vreg5 vs2, simm1 simm5, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && simm5.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vadd_vim;
/* dec.? = vd unhandled */
/* dec.? = vs2 unhandled */
	dec.imm = simm5;
...
bool riscv::asm_vrsub_vim(assembler &as, vreg5 vd, vreg5 vs2, simm1 simm5, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && simm5.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vrsub_vim;
...
bool riscv::asm_vand_vim(assembler &as, vreg5 vd, vreg5 vs2, simm1 simm5, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && simm5.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vand_vim;
...
bool riscv::asm_vor_vim(assembler &as, vreg5 vd, vreg5 vs2, simm1 simm5, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && simm5.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vor_vim;
...
bool riscv::asm_vxor_vim(assembler &as, vreg5 vd, vreg5 vs2, simm1 simm5, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && simm5.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vxor_vim;
...
bool riscv::asm_vrgather_vim(assembler &as, vreg5 vd, vreg5 vs2, simm1 simm5, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && simm5.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vrgather_vim;
...
bool riscv::asm_vslideup_vim(assembler &as, vreg5 vd, vreg5 vs2, simm1 simm5, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && simm5.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vslideup_vim;
...
bool riscv::asm_vslidedown_vim(assembler &as, vreg5 vd, vreg5 vs2, simm1 simm5, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && simm5.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vslidedown_vim;
...
bool riscv::asm_vadc_vim(assembler &as, vreg5 vd, vreg5 vs2, simm1 simm5, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && simm5.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vadc_vim;
...
bool riscv::asm_vmadc_vim(assembler &as, vreg5 vd, vreg5 vs2, simm1 simm5, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && simm5.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmadc_vim;
...
bool riscv::asm_vmerge_vim(assembler &as, vreg5 vd, vreg5 vs2, simm1 simm5, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && simm5.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmerge_vim;
...
bool riscv::asm_vmseq_vim(assembler &as, vreg5 vd, vreg5 vs2, simm1 simm5, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && simm5.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmseq_vim;
...
bool riscv::asm_vmsne_vim(assembler &as, vreg5 vd, vreg5 vs2, simm1 simm5, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && simm5.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmsne_vim;
...
bool riscv::asm_vmsleu_vim(assembler &as, vreg5 vd, vreg5 vs2, simm1 simm5, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && simm5.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmsleu_vim;
...
bool riscv::asm_vmsle_vim(assembler &as, vreg5 vd, vreg5 vs2, simm1 simm5, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && simm5.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmsle_vim;
...
bool riscv::asm_vmsgtu_vim(assembler &as, vreg5 vd, vreg5 vs2, simm1 simm5, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && simm5.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmsgtu_vim;
...
bool riscv::asm_vmsgt_vim(assembler &as, vreg5 vd, vreg5 vs2, simm1 simm5, vreg1 v0t)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && simm5.valid() && v0t.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmsgt_vim;
...
bool riscv::asm_vredsum_vs(assembler &as, vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vredsum_vs;
...
bool riscv::asm_vredand_vs(assembler &as, vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vredand_vs;
...
bool riscv::asm_vredor_vs(assembler &as, vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vredor_vs;
...
bool riscv::asm_vredxor_vs(assembler &as, vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vredxor_vs;
...
bool riscv::asm_vredminu_vs(assembler &as, vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vredminu_vs;
...
bool riscv::asm_vredmin_vs(assembler &as, vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vredmin_vs;
...
bool riscv::asm_vredmaxu_vs(assembler &as, vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vredmaxu_vs;
...
bool riscv::asm_vredmax_vs(assembler &as, vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vredmax_vs;
...
bool riscv::asm_vmv_x_s(assembler &as, ireg5 rd, vreg5 vs2)
{
	decode dec;
	if (!(rd.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmv_x_s;
	dec.rd = rd;
/* dec.? = vs2 unhandled */
	as.add_inst(encode_inst(dec));
...
bool riscv::asm_vpopc_m(assembler &as, ireg5 rd, vreg5 vs2)
{
	decode dec;
	if (!(rd.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vpopc_m;
...
bool riscv::asm_vfirst_m(assembler &as, ireg5 rd, vreg5 vs2)
{
	decode dec;
	if (!(rd.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfirst_m;
...
bool riscv::asm_vmfeq_vx(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmfeq_vx;
...
bool riscv::asm_vmfle_vx(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmfle_vx;
...
bool riscv::asm_vmflt_vx(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmflt_vx;
...
bool riscv::asm_vmfne_vx(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmfne_vx;
...
bool riscv::asm_vfmul_vv(assembler &as, vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfmul_vv;
...
bool riscv::asm_vfwadd_vv(assembler &as, vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfwadd_vv;
...
bool riscv::asm_vfwredsum_vv(assembler &as, vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfwredsum_vv;
...
bool riscv::asm_vfwsub_vv(assembler &as, vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfwsub_vv;
...
bool riscv::asm_vfwredosum_vv(assembler &as, vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfwredosum_vv;
...
bool riscv::asm_vfwadd_wv(assembler &as, vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfwadd_wv;
...
bool riscv::asm_vfwsub_wv(assembler &as, vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfwsub_wv;
...
bool riscv::asm_vfwmul_vv(assembler &as, vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfwmul_vv;
...
bool riscv::asm_vfdot_vv(assembler &as, vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfdot_vv;
...
bool riscv::asm_vfwmacc_vv(assembler &as, vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfwmacc_vv;
...
bool riscv::asm_vfwnmacc_vv(assembler &as, vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfwnmacc_vv;
...
bool riscv::asm_vfwmsac_vv(assembler &as, vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfwmsac_vv;
...
bool riscv::asm_vfwnmsac_vv(assembler &as, vreg5 vd, vreg5 vs2, vreg5 vs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && vs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfwnmsac_vv;
...
bool riscv::asm_vfadd_vf(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfadd_vf;
...
bool riscv::asm_vfredsum_vf(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfredsum_vf;
...
bool riscv::asm_vfsub_vf(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfsub_vf;
...
bool riscv::asm_vfredosum_vf(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfredosum_vf;
...
bool riscv::asm_vfmin_vf(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfmin_vf;
...
bool riscv::asm_vfredmin_vf(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfredmin_vf;
...
bool riscv::asm_vfmax_vf(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfmax_vf;
...
bool riscv::asm_vfredmax_vf(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfredmax_vf;
...
bool riscv::asm_vfsgnj_vf(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfsgnj_vf;
...
bool riscv::asm_vfsgnjn_vf(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfsgnjn_vf;
...
bool riscv::asm_vfsgnjx_vf(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfsgnjx_vf;
...
bool riscv::asm_vfmv_s_f(assembler &as, vreg5 vd, ireg5 rs1)
{
	decode dec;
	if (!(vd.valid() && rs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfmv_s_f;
...
bool riscv::asm_vfmv_f_s(assembler &as, freg5 frd, vreg5 vs2)
{
	decode dec;
	if (!(frd.valid() && vs2.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfmv_f_s;
	dec.rd = frd;
/* dec.? = vs2 unhandled */
	as.add_inst(encode_inst(dec));
...
bool riscv::asm_vfmv_v_f(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfmv_v_f;
...
bool riscv::asm_vmfeq_vf(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmfeq_vf;
...
bool riscv::asm_vmfle_vf(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmfle_vf;
...
bool riscv::asm_vmflt_vf(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmflt_vf;
...
bool riscv::asm_vmfne_vf(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmfne_vf;
...
bool riscv::asm_vmfgt_vf(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmfgt_vf;
...
bool riscv::asm_vmfge_vf(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vmfge_vf;
...
bool riscv::asm_vfdiv_vf(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfdiv_vf;
...
bool riscv::asm_vfrdiv_vf(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfrdiv_vf;
...
bool riscv::asm_vfmul_vf(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfmul_vf;
...
bool riscv::asm_vfrsub_vf(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfrsub_vf;
...
bool riscv::asm_vfwadd_vf(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfwadd_vf;
...
bool riscv::asm_vfwredsum_vf(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfwredsum_vf;
...
bool riscv::asm_vfwsub_vf(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfwsub_vf;
...
bool riscv::asm_vfwredosum_vf(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfwredosum_vf;
...
bool riscv::asm_vfwadd_wf(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfwadd_wf;
...
bool riscv::asm_vfwsub_wf(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfwsub_wf;
...
bool riscv::asm_vfwmul_vf(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfwmul_vf;
...
bool riscv::asm_vfdot_vf(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfdot_vf;
...
bool riscv::asm_vfwmacc_vf(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfwmacc_vf;
...
bool riscv::asm_vfwnmacc_vf(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfwnmacc_vf;
...
bool riscv::asm_vfwmsac_vf(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfwmsac_vf;
...
bool riscv::asm_vfwnmsac_vf(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfwnmsac_vf;
...
bool riscv::asm_vfsqrt_v(assembler &as, vreg5 vd, vreg5 vs2, freg5 frs1)
{
	decode dec;
	if (!(vd.valid() && vs2.valid() && frs1.valid())) return false; /* illegal instruction */
	dec.op = rv_op_vfsqrt_v;
